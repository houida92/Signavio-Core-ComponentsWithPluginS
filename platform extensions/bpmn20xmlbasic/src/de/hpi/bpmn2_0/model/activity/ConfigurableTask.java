...
@XmlType(name = "tConfigurableTask")
@XmlSeeAlso({
    ManualTask.class,
    ServiceTask.class,
    ScriptTask.class,
    ...
    extends Activity
{
	 ...
	 * 
	 * @param task
	 * 		The {@link ConfigurableTask} to copy
	 */
	public ConfigurableTask(ConfigurableTask configurableTask) {
		super(configurableTask);
	}
	
	
	
	public void acceptVisitor(Visitor v){
		v.visitConfigurableTask(this);
	}
