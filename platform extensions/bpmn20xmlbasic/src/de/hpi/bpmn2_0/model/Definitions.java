...
public class Definitions {
	...
	@XmlElementRefs( { @XmlElementRef(type = Process.class),
			...
			@XmlElementRef(type = Compute.class),
			@XmlElementRef(type = Network.class),
			@XmlElementRef(type = Assignment.class),
			@XmlElementRef(type = Elasticity.class),
			@XmlElementRef(type = Sharingbatching.class)})
