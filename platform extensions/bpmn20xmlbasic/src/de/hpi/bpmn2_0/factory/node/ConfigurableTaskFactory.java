 ...
 * 
 */
@StencilId("ConfigurableTask")
public class ConfigurableTaskFactory extends AbstractActivityFactory {
	...
	protected Activity createProcessElement(GenericShape shape)
		...
		try {
			ConfigurableTask task = (ConfigurableTask) this.invokeCreatorMethodAfterProperty(shape);
	...
	public ConfigurableTask createTask(GenericShape shape) {
	 ...
	 */
	private void setActivityResources(ConfigurableTask task, String resourcesProperty) {
		try {
	 ...
	 * @return
	 */
	private CallActivity handleCallActivity(ConfigurableTask t, GenericShape s) {
