...
*/
ORYX.Plugins.Bpmn2Eventb = ORYX.Plugins.AbstractPlugin.extend({
    /**@private*/
    construct: function(){
        ...
        this.facade.offer({
            'name': ORYX.I18N.Bpmn2Eventb.name,
            'functionality': this.transform.bind(this),
            'group': ORYX.I18N.Bpmn2Eventb.group,
            'icon': ORYX.PATH + "images/bpmn2eventb_icon.png",
            'description': ORYX.I18N.Bpmn2Eventb.desc,
            'index': 0,
            'toggle': true,
            'minShape': 0,
            'maxShape': 0
    ...
    new Ajax.Request(prefix + 'bpmn2eventb/', {method : 'get'});
    Ext.Msg.alert(ORYX.I18N.Oryx.title, 'OKKKK!!!');
    },
